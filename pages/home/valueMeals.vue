<template>
	<div class="home">
		...
		<div class="main">
			...
			<view class="select">
				<view class="type">
					<span style="color:rgba(255,62,62,1);margin-right: 6px;font-size: 14px;">*</span>
					<span style="font-size:14px;color:rgba(51,51,51,1);">首页图片</span>
				</view>
				<view class="uploads">
			...
			<view class="select">
				<view class="type">
					<span style="color:rgba(255,62,62,1);margin-right: 6px;font-size: 14px;">*</span>
					<span style="font-size:14px;color:rgba(51,51,51,1);">商品图片</span>
				</view>
				<!-- 上传图片开始 -->
				<view class="uploads">
					<view class='upload-image-view'>
						...
						<view class='info'>上传商品/菜品图片，您还可上传{{9 - gInfoNew.imgUrlList.length}}张。</view>
					</view>
				</view>
				<!-- 上传图片结束 -->
			</view>
...
<script>
	...
	export default {
			...
			methods: {
				...
				// 图片信息保存到data数组
				async upOosData(imgUrl) {this.gInfoNew.imgUrlList.push(imgUrl)},
				// 开始时间
...
<style lang="less" scoped>
	...
	.main{
		...
		.select {
			...
			.upload-image-view .add-view .cross .transverse-line,.upload-image-view .add-view .cross .vertical-line {
				height: 100%;
				width: 48%;
				position: absolute;
				top: 0;
